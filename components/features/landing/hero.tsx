    ...
    <section className="relative min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-20 lg:pb-24">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          {/* Left Content */}
          <div className="space-y-4 space-x-3.5 sm:space-y-8 lg:space-y-10 pt-8 sm:pt-12 lg:pt-16 ">
            {/* Main Heading */}
            <div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight">
                KAZI: Connecting
              </h1>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 leading-tight whitespace-nowrap">
          ...
          {/* Right Content - Image Card that overlaps navbar */}
          <div className="relative mt-0 lg:mt-0 -mt-10 sm:-mt-12 lg:-mt-30">
              ...
              <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8 rounded-2xl sm:rounded-3xl bg-white/30 backdrop-blur-xl border border-white/50 p-4 sm:p-6 shadow-xl">
                ...
                <div className="flex items-center -space-x-3 mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-white bg-linear-to-br from-blue-400 to-blue-600 overflow-hidden">
                    <Image src="/images/Ellipse_95.png" alt="User" className="w-full h-full object-cover" width={100}
                  height={100} />
                  </div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-white bg-gradient-to-br from-purple-400 to-purple-600 overflow-hidden">
                    <Image src="/images/Ellipse_96.png" alt="User" className="w-full h-full object-cover" width={100}
                  height={100} />
                  </div>
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-white bg-gradient-to-br from-pink-400 to-pink-600 overflow-hidden">
                    <Image src="/images/Ellipse_97.png" alt="User" className="w-full h-full object-cover" width={100}
                  height={100} />
                  </div>
